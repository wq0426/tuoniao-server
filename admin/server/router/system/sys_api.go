...
func (s *ApiRouter) InitApiRouter(Router *gin.RouterGroup, RouterPub *gin.RouterGroup) {
	...
	}
	{
		...
		apiPublicRouterWithoutRecord.POST("getFreeSite", apiRouterApi.GetFreeSite)
		apiPublicRouterWithoutRecord.POST("createAgent", apiRouterApi.CreateAgent)
		apiPublicRouterWithoutRecord.GET("getAgentList", apiRouterApi.GetAgentList)
	}
}
