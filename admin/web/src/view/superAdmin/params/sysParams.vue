...
<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="80">
          ...
          <el-table-column align="left" label="参数值" prop="value" width="620" />
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="参数值:"  prop="value" >
              <el-input type="textarea" :rows="10" v-model="formData.value" :clearable="true"  placeholder="请输入参数值" />
            </el-form-item>
